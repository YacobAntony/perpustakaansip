                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/buku/{{$item->id}}" style="display : inline;" method="POST"
                                    id="delete-form">
                                    @csrf
                                    @method('delete')
                                    ...
                                    <a class="btn btn-sm btn-success" href="/buku/print/{{$item->id}}"
                                        class="btn btn-sm btn-primary">Export to PDF</a>
                                </form>
                            </td>
                        </tr>
                        @endforeach
